            ...
            <div className="bg-white rounded-t-xl">
                <div className="flex justify-center flex-col w-8/12 mx-auto rounded-t-xl">
                    ...
                    <form className="pt-4 flex flex-col w-62">
                        <input type="number" className="border-2 p-2 rounded-xl my-3" placeholder="Nomor Induk Kependudukan"/>
                    ...
                    <button className="px-4 py-2 bg-blue text-white rounded-lg mt-8">Masuk</button>
                    <div className="flex flex-row mt-4 justify-center text-sm">
                        <p>Belum punya akun? </p>
                        <p className="text-blue-500 underline ml-2">Daftar disini</p>
                    </div>
                </div>
            </div>
        </div>
